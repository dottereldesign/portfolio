...
if (heroModelCanvas) {
  import("./assets/vendor/laptop-runtime.min.js?v=20260730-5").then(({ Scene, PerspectiveCamera, WebGLRenderer, AmbientLight, DirectionalLight, Group, MathUtils, MeshStandardMaterial, MeshBasicMaterial, PlaneGeometry, Mesh, BackSide, DoubleSide, CanvasTexture, LinearFilter, SRGBColorSpace, Raycaster, Vector2, Color, GLTFLoader }) => {
